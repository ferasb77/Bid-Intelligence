...
This architecture implements the conclusion of [Opportunity Orchestration Architectural Review](OPPORTUNITY_ORCHESTRATION_ARCHITECTURAL_REVIEW.md): a distinct orchestration architecture is constitutionally required, while a new semantic domain, owner publication, resolver, intelligence layer, or runtime service is not.
